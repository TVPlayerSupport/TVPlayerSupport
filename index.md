...
最近有多个用户表示下载后不会使用，也有用户发邮件咨询，因此强烈建议您抽点时间看看使用说明，在看过使用说明后，有用户很快回复邮件，表示已经制作好播放文件，我很高兴，只要你愿意动手，实在是没什么难度。
播放器的操作使用比较简单，主要内容包括：
...
- [下载播放器使用说明 (第六版2018-12-27更新)](https://TVPlayerSupport.github.io/Playlist/IPTVPlayerGuidelines.pdf) 
