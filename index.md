...
- 因比较享受拖放操作，开始并没有做保存列表的功能。根据这位用户的反馈，增加了自动保存列表功能。
...
- 在这里要特别感谢用户iBurning，提出了许多改进建议，前面的大更新，我们经常讨论，他还给专门制作视频录像给我发过来，我在更新之前也会先发截图让他看看，听听他的意见，他提出了很多非常好的建议。如今，我们已经成为朋友了。

![图标](213.png)

- 经过上面的升级后，国内用户比较满意，可是一个美国用户却不能接受，一边在商店里发布评论，一边给我发邮件沟通，要求返回到原先的版本。返回到原来的版本肯定不行，国内用户不会答应，但这个美国用户一再坚持喜欢老版本，也必须满足他的要求。经过多次沟通，专门又把下拉式列表添加上去。不过，下拉式列表一般情况是隐藏的，要使用的话，自己操作显示出来，这样做他表示可以接受。

![图标](300.png)

- 感谢所有给予播放器善意、中肯评价的用户，无论是好评还是差评，好评让我欣慰，差评我将尽力改进。当然也有一些评价不能接受，比如下面这个令人意外的评论。

![图标](311.png)

- 对于这样一个评价，我有点莫名其妙！我很难相信他说的情况是真实存在的，播放器本身不可能存在任何额外收费的情况，在苹果应用商店内购买的软件也不可能出现这种情况。
- 希望意外情况能够得到及时的处理，方可安心。
