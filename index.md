...
虽然播放器操作比较简单，但为让大家更好的了解播放器的各种功能，特编写播放器的使用说明，需要的可以下载看看。
...
- 播放器上线以后，一些用户根据自己的使用情况，提出了使用和功能方面的建议，这里汇总几个有代表性的。

![图标](100.png)

![图标](101.png)

- 播放器上线之初，没有提供模版文件下载，许多用户不会制作源文件。根据用户反馈，建立个人网页提供源模版文件下载，但有人找不到支持页面，来邮件的都一一回复，没有联系的，也无可奈何，只能希望他们能自己找到网页。至于有反馈说支持页面打不开，我只能望洋兴叹了，境外服务器，有时候就是慢些。

![图标](102.png)

- 不光是国内用户不会制作源文件，发达的美国用户也同样存在这样的问题，看到上面的评论，没有给我发邮件，只能在商店给他回复，确实不知道他用的什么地址，一个都打不开我也很奇怪。

![图标](200.png)

- 因自己比较享受拖放操作，就没有做保存列表的功能。根据这位用户的反馈，增加了自动保存列表功能。
...
- 纯粹的全屏是反馈最多的，还有播放列表的长度问题。原来窗口上部和下部放有一些操作键，播放列表也是下拉式的，不能实现分类功能，因为用户反映比较强烈，所以下决心进行彻底的改进和升级，取消了所有的窗口内操作按钮，将下拉式列表改为列表式，增加了分类保存功能，实现纯粹的全屏。

- 在这里要特别感谢用户iBurning，给我提出了许多改进建议，前面的大更新，我们经常讨论，还给我发视频录像，我的更新也会先让他看看，然后再反馈给我，给了我很多非常好的建议。如今，我们已经成为朋友了。

![图标](213.png)

- 经过上面的升级后，国内用户比较满意，可是一个美国用户却不能接受，一边在商店里发布评论，一边给我发邮件沟通，要求返回到原先的版本。返回到原来的版本肯定不行，国内用户不会答应，但这个美国用户一再坚持喜欢老版本，也必须满足他的要求。经过多次沟通，专门又把下拉式列表添加上去。不过，下拉式列表一般情况是隐藏的，要使用的话，自己操作显示出来，这样做他表示接受。

![图标](300.png)

- 感谢所有给予善意、中肯评价的用户，无论是好评还是差评，好评让我欣慰，差评我将尽力改进。当然也有一些评价不能接受，比如下面这个奇葩的评论。

![图标](311.png)

- 对于这样一个评价，我有点莫名其妙！我很难相信他说的情况是真实存在的，播放器本身不可能存在额外收费的情况，在苹果应用商店内购买的软件也不可能出现这种情况，这完全是无中生有的抹黑，不知道他到底有什么目的？
