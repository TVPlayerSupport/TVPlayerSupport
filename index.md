...
IPTV播放器, 在您的iMac上看电视，听广播，可以替代电视盒子+显示器，省钱省事省空间。
网络电视直播资源十分丰富，只要花点时间，下点功夫，就能找到您想看的、丰富多彩的、世界各地的电视、电影。

App本身不带任何直播源地址，支持用户自己定制，想看什么电视、电影频道，完全由自己制作的播放列表文件确定。
只需将广播电视播放列表文件拖入播放窗口或打开即可。

直播源定制让熟练掌握源的人随心所欲，想看什么就有什么；但也给一些不熟悉这方面的新人造成了一点困难，
为了满足其基本需求，特制作了模版文件，供下载使用。
...
（1）根据用户的使用要求，视频播放实现纯粹的全屏化，变化最大的就是频道切换由原来的下拉式按钮改为列表式，而且，播放列表一般情况下是隐藏的。那么如何显示或隐藏播放列表？
- 鼠标控制
...
- 支持m3u8广播电视直播（广播电视播放列表文件由用户定制）。
- 支持mp4视频点播。
- 支持的视频格式有m3u8, mp4, mp3. . . . . .
- 支持全屏播放。
- 支持文件的拖放操作。
- 支持txt和m3u格式播放文件列表。
- 自动保存(仅支持txt格式的列表文件)最新打开或拖入的直播源文件。
...
- 如果出现卡顿、失效的源，请自己删除。
- 
- [新增源专用模版文件](https://TVPlayerSupport.github.io/Playlist/myTVsrc.txt.zip)  2018年07月23日更新。
- 
...
- (03)[省市地方](https://TVPlayerSupport.github.io/Playlist/Local.txt.zip)  2018年07月23日更新。
...
- (06)[体育频道](https://TVPlayerSupport.github.io/Playlist/Sports.txt.zip)  2018年07月21日更新。
...
- (12)[综合杂类](https://TVPlayerSupport.github.io/Playlist/Others.txt.zip)  2018年07月23日更新。
